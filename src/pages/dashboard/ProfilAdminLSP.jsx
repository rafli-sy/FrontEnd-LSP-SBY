...
const ProfilAdminLSP = () => {
  const [formData, setFormData] = useState({
    namaLengkap: 'Admin Utama LSP',
    noTelp: '081234567890',
    email: 'admin.lsp@blksurabaya.com',
  });
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    alert('Perubahan data profil Admin LSP berhasil disimpan!');
  };
