...
const LoginPage = () => {
  ...
  const handleLogin = (e) => {
    ...
    } else if (userEmail.includes('lsp') && !userEmail.includes('staff')) {
    ...
    <div className="login-container">
      <div className="login-card">
        <div className="login-header">
          ...
          <p>Ketik "blk@mail.com" untuk Admin BLK, "lsp@mail.com" untuk Admin LSP, dll.</p>
        </div>
          ...
          <div className="form-group">
            ...
            <div className="input-with-icon">
              ...
              <input 
                type="email" 
                id="email" 
                placeholder="Contoh: blk@mail.com" 
                value={email}
