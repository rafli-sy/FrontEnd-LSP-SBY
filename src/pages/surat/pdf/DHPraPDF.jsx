      ...
      <Page size="A4" orientation="landscape" style={styles.page}>
        ...
        <View style={styles.isoTable}>
          ...
          <View style={styles.isoTitleBox}>
            ...
            <Text style={[styles.bold, { fontSize: 14 }]}>FORMULIR DAFTAR HADIR PRA ASESMEN</Text>
          </View>
        ...
        <View style={styles.infoTable}>
          ...
          <View style={styles.infoRow}>
             <Text style={styles.infoCellHeader}>HARI / TANGGAL</Text><Text style={styles.infoCellData}>{ujk?.hari1}</Text>
        ...
        <View style={styles.table}>
          ...
          {/* Baris Peserta Zig-Zag TTD */}
          {daftarAsesi.map((nama, i) => {
            const isOdd = i % 2 !== 0; // index ganjil berarti baris kanan
            return (
            <View style={[styles.tRow, i === daftarAsesi.length - 1 && { borderBottomWidth: 0 }]} key={i} wrap={false}>
              ...
              <View style={[styles.colCell, { width: '5%' }]}></View>
              <View style={[styles.colCell, { width: '5%' }]}><Text style={[styles.tCellText, {textAlign: 'center'}]}>V</Text></View>
              <View style={[styles.colCell, { width: '5%' }]}></View>
              ...
              <View style={[styles.colCell, { width: '15%' }]}></View>
        ...
        {/* Tanda Tangan Footer */}
        <View style={{ alignItems: 'flex-end', marginBottom: 5 }}><Text>Tanggal: .......................................</Text></View>
        <View style={styles.ttdContainer} wrap={false}>
          <View style={styles.ttdHeaderRow}>
            ...
            <View style={[{ width: '65%', padding: 5 }]}><Text style={styles.bold}>DIBUAT OLEH PEMATERI PRA ASESMEN</Text></View>
          </View>
          <View style={{ flexDirection: 'row' }}>
