...
const PernyataanAsesor1PDF = ({ data }) => {
  const { ujk } = data;
    ...
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <View style={{ marginLeft: 30, marginBottom: 20 }}>
          <View style={styles.row}><Text style={styles.col1}>Nama Asesor</Text><Text style={styles.col2}>:</Text><Text style={styles.col3}>{ujk?.asesor1}</Text></View>
          <View style={styles.row}><Text style={styles.col1}>No. Reg</Text><Text style={styles.col2}>:</Text><Text style={styles.col3}>{ujk?.noReg1}</Text></View>
          ...
          <View style={styles.row}><Text style={styles.col1}>Alamat</Text><Text style={styles.col2}>:</Text><Text style={styles.col3}>-</Text></View>
          <View style={styles.row}><Text style={styles.col1}>No. HP</Text><Text style={styles.col2}>:</Text><Text style={styles.col3}>082231728778</Text></View>
        </View>
        ...
        <View style={styles.ttdContainer} wrap={false}>
          ...
          <Text style={[styles.bold, { marginTop: 60, textDecoration: 'underline' }]}>{ujk?.asesor1}</Text>
        </View>
...
export default PernyataanAsesor1PDF;