      ...
      <Page size="A4" orientation="landscape" style={styles.page}>
        <View style={styles.isoTable}>
          ...
          <View style={styles.isoTitleBox}>
            ...
            <Text style={[styles.bold, { fontSize: 14 }]}>FORMULIR DAFTAR HADIR ASESMEN</Text>
          </View>
        ...
        <View style={{ alignItems: 'flex-end', marginBottom: 5 }}><Text>Tanggal: {ujk?.hari1}</Text></View>
