...
const kertasA4 = { 
  ...
  width: '297mm', minHeight: '210mm', // Landscape (Mendatar)
        ...
        <tbody>
          ...
          <tr>
            <td rowSpan="3" style={{ ...tdMutuStyle, textAlign: 'center', fontSize: '1.3rem', fontWeight: 'bold' }}>
              FORMULIR<br/>DAFTAR HADIR PRA ASESMEN
            </td>
      ...
      <table style={tableInfoStyle}>
        <tbody>
          <tr>
            ...
            <td style={{ ...tdInfoStyle, width: '20%' }}>1 Kelas / {ujk.asesi || 16} Peserta</td>
          </tr>
          <tr>
            <td style={tdInfoStyle}>HARI/TANGGAL</td>
            <td style={tdInfoStyle}>....................................................</td>
      ...
      <table style={tableDataStyle}>
        ...
        <tbody>
          {daftarAsesi.map((nama, index) => {
            const isOdd = index % 2 !== 0; // Ganjil genap untuk layout Tanda Tangan Zig-Zag
            return (
              <tr key={index}>
                <td style={{ ...tdDataStyle, textAlign: 'center' }}>{index + 1}</td>
                <td style={{ ...tdDataStyle, paddingLeft: '8px' }}>{nama}</td>
                
                {/* Kolom Pendidikan (Mockup centang di SMA) */}
      ...
      <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.85rem', textAlign: 'center' }}>
        <tbody>
          <tr>
            ...
            <td colSpan="3" style={{ border: '1px solid #000', padding: '6px' }}>DIBUAT OLEH PEMATERI PRA ASESMEN</td>
          </tr>
          <tr>
